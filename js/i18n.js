const translations = {
  ...
  es: {
    ...
    "experience.minsait_2": "Lidere el diseno y despliegue de mas de 10 productos de Vision Artificial en sectores urbano, transporte, aviacion, energia y medioambiental en Espana, Europa y EEUU.",
    ...
    "projects.neuron_title": "SESAR NEURON | IA Aeroportuaria de Nueva Generacion",
    "projects.neuron_desc": "Diseno de la solucion y liderazgo del arranque de la inteligencia visual con IA para torres digitales en NEURON, proyecto de la SESAR 3 JU coordinado por Indra. En curso (2026-2029).",
    "projects.neuron_details": "NEURON (NEw aiRport Operational service Network) es un proyecto de la SESAR 3 Joint Undertaking bajo Horizonte Europa, coordinado por Indra con EUROCONTROL como integrador de red y un consorcio de 23 socios que incluye a Airbus, ENAV/TechnoSky y aeropuertos early-adopter como el Aeropuerto Internacional de Atenas. Disene la solucion tecnica de principio a fin y lidere el arranque de la solucion de inteligencia visual con IA para torres digitales: tracking visual en tiempo real, suavizado de trayectorias, deteccion meteorologica basada en video y monitorizacion de seguridad del aerodromo, con objetivo TRL6. El proyecto esta en curso, de 2026 a 2029, hacia la vision del Digital European Sky de SESAR.",
    ...
    "projects.copilot_title": "Traffic Control Copilot | Conformidad de Senales",
    ...
    "projects.telco_details": "Prueba de concepto para un gran operador de telecomunicaciones: deteccion y seguimiento multiobjeto en tiempo real sobre flujos de camaras en directo, con persistencia de identidad ante oclusiones y cambios de camara. El pipeline combina detectores estado del arte con algoritmos modernos de tracking-by-detection, optimizado para inferencia en GPU y disenado para escalar en grandes redes de camaras.",
    "projects.ocean_title": "OceanGuard AI | Deteccion de Residuos Marinos On-Device",
    ...
    "projects.ocean_details": "Nacio como plataforma de IA para mapear contaminacion marina con un VLM Gemma3n fine-tuned (Google Gemma3n Hackathon) y evoluciono para el Gemma 4 Good Hackathon a una app Android totalmente offline que ejecuta dos modelos de IA en el dispositivo: RT-DETRv2 para escaneo de camara en tiempo real (~30ms por frame) y Gemma 4 E2B Vision como detector visual zero-shot que genera bounding boxes nativas. La app tambien produce informes de impacto ambiental en el dispositivo, situa las detecciones geolocalizadas en mapas offline, gamifica las limpiezas con la guia MarineDex y esta disponible en 6 idiomas, sin ninguna dependencia de la nube.",
    "projects.padel_title": "PadelCortex | Planificacion Inteligente de Torneos",
    "projects.padel_desc": "Organizador de torneos de padel con scheduling automatico segun disponibilidad de jugadores y club.",
    "projects.padel_details": "Plataforma web full-stack que organiza torneos de padel de principio a fin: recoge la disponibilidad de cada pareja, la cruza con el horario de pistas del club y genera (o reorganiza) los cuadros minimizando desplazamientos. Construida con Next.js y React, TypeScript, Tailwind CSS y Prisma sobre PostgreSQL, con interfaz bilingue y un motor de scheduling desacoplado que combina heuristicas greedy con busqueda local.",
    ...
    "demos.more_options": "Mas opciones",
    ...
    "demos.tab_vlm": "Vision Language",
    "demos.vlm_title": "Modelo de Vision y Lenguaje",
    "demos.vlm_meta": "256M parametros | ~600MB modelo (primera carga, cacheado) | Requiere WebGPU",
    ...
    "demos.vlm_preset_objects": "Que objetos ves?",
    "demos.vlm_preset_scene": "Que esta pasando en esta escena?",
    ...
    "demos.vlm_ready_wasm": "Modelo listo (modo CPU, mas lento) -sube una imagen y genera",
    ...
    "publications.paper3_title": "Un Enfoque Data-Centric para la Deteccion de Residuos Submarinos en Tiempo Real",
    "publications.paper3_status": "En Revision",
