const translations = {
  en: {
    ...
    "demos.vlm_meta": "256M params | ~175MB model (first load) | WebGPU required",
    ...
    "demos.vlm_loading": "Downloading SmolVLM model (~175MB, first time only)...",
  ...
  es: {
    ...
    "demos.vlm_meta": "256M parametros | ~175MB modelo (primera carga) | Requiere WebGPU",
    ...
    "demos.vlm_loading": "Descargando modelo SmolVLM (~175MB, solo la primera vez)...",
