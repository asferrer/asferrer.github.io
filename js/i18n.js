const translations = {
  en: {
    ...
    "projects.jarvis_title": "SESAR JARVIS | Airport Safety AI",
    "projects.jarvis_desc": "AI detection of FOD, taxiway incursions and wildlife hazards for the Airport Digital Assistant, validated with Athens International Airport.",
    "projects.jarvis_details": "Within JARVIS, a SESAR 3 Joint Undertaking project under Horizon Europe, this work delivers real-time computer vision for airport safety as part of the Airport Digital Assistant, led by Athens International Airport together with EUROCONTROL, Indra and Swedavia. The system reuses existing fixed cameras to detect foreign object debris (FOD), taxiway incursions and wildlife hazards, sending AI-generated alerts to controllers and airport operations centres. Training combines real footage with synthetic datasets generated in Blender, and the full lifecycle follows the EASA AI Roadmap objectives for trustworthy, explainable and safe AI in aviation.",
  ...
  es: {
    ...
    "projects.jarvis_title": "SESAR JARVIS | IA para Seguridad Aeroportuaria",
    "projects.jarvis_desc": "Deteccion con IA de FOD, incursiones en calles de rodaje y fauna para el Airport Digital Assistant, validado con el Aeropuerto Internacional de Atenas.",
    "projects.jarvis_details": "Dentro de JARVIS, proyecto de la SESAR 3 Joint Undertaking bajo Horizonte Europa, este trabajo aporta vision artificial en tiempo real para la seguridad aeroportuaria como parte del Airport Digital Assistant, liderado por el Aeropuerto Internacional de Atenas junto a EUROCONTROL, Indra y Swedavia. El sistema reutiliza las camaras fijas existentes para detectar objetos extranos en pista (FOD), incursiones en calles de rodaje y presencia de fauna, enviando alertas generadas por IA a controladores y centros de operaciones. El entrenamiento combina imagenes reales con datasets sinteticos generados en Blender, y todo el ciclo de vida sigue los objetivos del AI Roadmap de EASA para una IA fiable, explicable y segura en aviacion.",
