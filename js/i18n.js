const translations = {
  en: {
    ...
    "demos.vlm_loading_wasm": "Downloading SmolVLM model (CPU mode, ~600MB, first time only)...",
  ...
  es: {
    ...
    "demos.vlm_loading_wasm": "Descargando modelo SmolVLM (modo CPU, ~600MB, solo la primera vez)...",
