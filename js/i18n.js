const translations = {
  en: {
    ...
    "demos.vlm_loading": "Downloading SmolVLM model (~600MB, first time only)...",
    "demos.vlm_loading_wasm": "Downloading SmolVLM model (CPU mode, ~175MB, first time only)...",
  ...
  es: {
    ...
    "demos.vlm_loading": "Descargando modelo SmolVLM (~600MB, solo la primera vez)...",
    "demos.vlm_loading_wasm": "Descargando modelo SmolVLM (modo CPU, ~175MB, solo la primera vez)...",
