const translations = {
  en: {
    ...
    "projects.ocean_details": "Comprehensive platform for monitoring marine pollution using on-device AI. Automatically detects and classifies debris from images, visualizes data on an interactive map, and generates detailed reports with mitigation strategies. First built with a fine-tuned Gemma3n VLM for the Google Gemma3n Hackathon, and evolved into an on-device agentic marine debris detection system with Gemma 4 for the Gemma 4 Good Hackathon.",
  ...
  es: {
    ...
    "projects.ocean_details": "Plataforma integral para monitorizacion de contaminacion marina usando IA on-device. Detecta y clasifica automaticamente residuos, visualiza datos en un mapa interactivo y genera informes con estrategias de mitigacion. Desarrollada primero con un VLM Gemma3n fine-tuned para el Google Gemma3n Hackathon, y evolucionada a un sistema agentico on-device de deteccion de residuos marinos con Gemma 4 para el Gemma 4 Good Hackathon.",
