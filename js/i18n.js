const translations = {
  en: {
    ...
    "demos.vlm_loading_wasm": "Downloading SmolVLM model (CPU mode, ~260MB, first time only)...",
  ...
  es: {
    ...
    "demos.vlm_loading_wasm": "Descargando modelo SmolVLM (modo CPU, ~260MB, solo la primera vez)...",
